      ...
      <header className="bg-white border-b border-gray-100 shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {currentUser ? (
              <>
                <Link href="/dashboard" className="hidden md:flex items-center gap-2 text-sm text-gray-700 hover:text-[#0EA5E9]">
              ...
              <>
                <Link href="/login" className="hidden md:inline-flex text-sm font-semibold text-[#0EA5E9] hover:underline">
                  Đăng nhập
                </Link>
                <Link href="/register" className="px-4 py-2 bg-[#0EA5E9] text-white rounded-full text-sm font-semibold hover:bg-[#0284C7] transition-colors">
                  Đăng ký
                </Link>
              </>
            )}
